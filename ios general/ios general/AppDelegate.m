...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    Employee *employee = [[Employee alloc]initWithFirstName: @"Genady"
                                                   lastName: @"Adolfovich"
                                                     salary: 100];
    ...
    [org addEmployee:[[Employee alloc]initWithFirstName: @"Beda"
                                               lastName: @"Marfa"
                                                 salary: 400]];
    ...
    //    [org removeEmployee:[[Employee alloc]initWithFirstName: @"No"
    //                                                  lastName: @"One"
    //                                                    salary: 00]];
